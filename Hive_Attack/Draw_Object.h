...
void Draw_Instanced_Object(GLFWwindow * window, GLuint shader_program, glm::vec3 lightPos, model_buffer_specs model_specs, instanced_buffer_specs instance_specs, int num_items_to_render, vec3 Base_Color, mat4* swarm_model_matrices);
